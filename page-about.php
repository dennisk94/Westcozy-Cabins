	...
	<main id="primary" class="site-main">
		...
		while ( have_posts() ) :
			...
			<section class='our-story-wrapper'>
				...
				<article class='story-article'> <?php
				...
				if(function_exists('the_field')): ?>
					<article class='story-article'> <?php
						if(get_field('bowen_island')):
							the_field('bowen_island');
						endif; 
						?>
					</article> 
					<?php
				...
				if(function_exists('the_field')): ?>
					<article class='story-article'> <?php
						if(get_field('westcozy_history')):
							the_field('westcozy_history');
						endif; 
						?>
					</article> 
					<?php
			...
			<section class='cabin-link'>
				<?php
				if(get_field('cabins_page')): ?>
					<a href="<?php the_field('cabins_page') ?>"><h3>Check Out Our Cabins</h3></a>
				<?php endif; ?>
			</section>
